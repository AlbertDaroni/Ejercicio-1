...
namespace Inmobiliaria_.Net_Core.Repositorios
{
    public class RepositorioTipoInmuebleMySql 
        : RepositorioBase, IRepositorio_Tipo_Inmueble
    {
        public RepositorioTipoInmuebleMySql(IConfiguration configuration)
            : base(configuration)
        {
        }
