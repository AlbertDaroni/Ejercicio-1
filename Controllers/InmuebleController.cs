...
namespace Inmobiliaria_.Net_Core.Controllers
{
    public class InmuebleController : Controller
    {
        ...
        public InmuebleController(
            IRepositorio_Inmueble repositorio,
        ...
        public IActionResult Crear(Models.Inmueble inmueble)
        {
            ...
            logger.LogInformation(
                $"Se registró correctamente el Inmueble con el ID: {id}");
        ...
        public IActionResult ConfirmarEliminar(int id)
        {
            ...
            logger.LogInformation(
                $"Se eliminó correctamente el Inmueble con el ID: {id}");
            ...
            Models.Inmueble inmueble)
        {
            ...
            logger.LogInformation(
                $"Se modificó correctamente el Inmueble con el ID: {id}");
        ...
        public IActionResult Direccion(string direccion)
        {
            return View(
                repositorio.ObtenerPorDireccion(direccion));
        }
    }
}